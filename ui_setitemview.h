...
"border:1px solid black"));
        ...
        label_4->setGeometry(QRect(10, 30, 101, 41));
...
"font-size:18px;"));
        ...
        studentID->setGeometry(QRect(130, 30, 150, 31));
        studentID->setStyleSheet(QLatin1String("border-style:solid;\n"
"border:1px solid black;\n"
"font-size:18px;"));
        label_2 = new QLabel(page_4);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(10, 140, 111, 31));
        label_2->setStyleSheet(QStringLiteral("font-size:14px;"));
        trachIP = new QLineEdit(page_4);
        trachIP->setObjectName(QStringLiteral("trachIP"));
        trachIP->setGeometry(QRect(120, 140, 171, 31));
        trachIP->setStyleSheet(QLatin1String("border-style:solid;\n"
"border:1px solid black;\n"
"font-size:18px;"));
    ...
    void retranslateUi(QDialog *SetItemView)
    {
        ...
        label_4->setText(QApplication::translate("SetItemView", "\346\234\254\346\234\272\345\256\236\351\252\214\345\217\260ID\357\274\232", Q_NULLPTR));
        label->setText(QApplication::translate("SetItemView", "\350\256\276\347\275\256WebIP:", Q_NULLPTR));
        label_2->setText(QApplication::translate("SetItemView", "\346\225\231\345\270\210\346\234\272IP", Q_NULLPTR));
